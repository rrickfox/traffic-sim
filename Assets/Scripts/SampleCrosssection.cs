...
public class SampleCrosssection : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        var lanes_left_incoming = new List<Lane>{new Lane(new HashSet<LaneType>(){LaneType.LeftTurn}), new Lane(new HashSet<LaneType>(){LaneType.Through}), new Lane(new HashSet<LaneType>(){LaneType.RightTurn})};
        ...
        var lanes_right_incoming = new List<Lane>{new Lane(new HashSet<LaneType>(){LaneType.LeftTurn}), new Lane(new HashSet<LaneType>(){LaneType.Through}), new Lane(new HashSet<LaneType>(){LaneType.RightTurn})};
        ...
        var lanes_up_incoming = new List<Lane>{new Lane(new HashSet<LaneType>(){LaneType.LeftTurn}), new Lane(new HashSet<LaneType>(){LaneType.Through})};
