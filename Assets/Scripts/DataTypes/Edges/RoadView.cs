...
namespace DataTypes
{
    ...
    public class RoadView
    {
        ...
        public RoadView(RoadShape shape, Vector2 position, Vector2 otherPosition,
            List<Lane> outgoingLanes, List<Lane> incomingLanes)
        {
            other = new RoadView(this, otherPosition, incomingLanes);
            this.shape = shape;
        ...
        private RoadView(RoadView other, Vector2 position, List<Lane> outgoingLanes)
        {
            this.other = other;
            _position = position;
            this.outgoingLanes = outgoingLanes;
        ...
        // copy a RoadView object (used by subclasses)
        protected RoadView(RoadView roadView)
        {
            other = roadView.other;
